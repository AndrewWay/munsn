! function (t, e) {
	...
	return function (t) {
		...
		e.protocol = 4, e.types = ["CONNECT", "DISCONNECT", "EVENT", "ACK", "ERROR", "BINARY_EVENT", "BINARY_ACK"], e.CONNECT = 0, e.DISCONNECT = 1, e.EVENT = 2, e.ACK = 3, e.ERROR = 4, e.BINARY_EVENT = 5, e.BINARY_ACK = 6, e.Encoder = n, e.Decoder = s, n.prototype.encode = function (t, r) {
			if (e.BINARY_EVENT == t.type || e.BINARY_ACK == t.type) i(t, r);
			else {
				var n = o(t);
				r([n])
			}
		...
		var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
			...
			h = r(40),
			p = r(41),
			u = (r(3)("socket.io-client:manager"), r(36)),
			f = r(42),
		...
		(function (e) {
			...
			var i = r(14),
				s = r(29),
				a = (r(3)("engine.io-client:socket"), r(36)),
				c = r(20),
				h = r(2),
				p = r(37),
				u = r(30);
		...
		(function (t, o) {
			! function (i) {
				...
				var m, g, v, b = String.fromCharCode,
					k = {
						version: "1.0.0",
						encode: p,
						decode: l
		...
		var o = r(4),
			...
			a = r(40),
			c = r(41),
			h = (r(3)("socket.io-client:socket"), r(22));
		t.exports = e = n;
		var p = {
				connect: 1,
				connect_error: 1,
